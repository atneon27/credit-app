...
const LoanList = () => {
  return (
    <Table className="bg-white ">
      <TableHeader>
        <TableRow>
          <TableHead className="w-[300px] text-gray-500 font-semibold">Loan Officer</TableHead>
          <TableHead className=" text-gray-500 font-semibold">Amount</TableHead>
          <TableHead className=" text-gray-500 font-semibold">Date Applied</TableHead>
          ...
          <TableRow key={data.id}>
            <TableCell className="font-medium p-5">
              <div className="flex flex-row items-center gap-2">
                <Avatar size="28px" name={data.officer.name} round color="grey" />
            ...
            <TableCell>{data.dateApplied}</TableCell>
            <TableCell>
              <div style={{backgroundColor: data.statusColor}} className={`p-1 rounded-full text-white flex items-center justify-center font-semibold`}>
                {data.status}
              </div>
            </TableCell>
            <TableCell className="text-right">
              <EllipsisVertical className="h-4 w-4 stroke-gray-400" />
            </TableCell>
          </TableRow>
        ))}
      </TableBody>
